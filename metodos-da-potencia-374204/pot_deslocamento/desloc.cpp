...
void deslocamento_Matriz(double matriz[tamanho][tamanho], double u) {
...
int main() {
	...
	printf("Entre o valor do deslocamento desejado\n");
	...
	printf("\nO autovalor mais próximo do deslocamento %.4f: %.4f\n", u,
	        (autovalor_atual) + u);
